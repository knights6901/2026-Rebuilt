...
public class ShooterSubsystem extends SubsystemBase {
    ...
    public ShooterSubsystem() {
        m_motorRight.getConfigurator().apply(ShooterConstants.MotorConfig);
        m_motorLeft.getConfigurator().apply(ShooterConstants.MotorConfig);
    ...
    // * launched
    // */
    // public void updateShotVisualization(Pose2d robotPose, double v0_mag, double
    // launchAngleDegrees) {
    ...
    // double currZ = 0.5 + (totalVz * t) - (0.5 * 9.81 * t * t); // Starting 0.5m
    // high
